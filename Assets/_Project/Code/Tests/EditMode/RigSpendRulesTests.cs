...
namespace MaxWorlds.Tests.EditMode
{
    ...
    public sealed class RigSpendRulesTests
    {
        ...
        [Test]
        public void UnlockingANodeNeedsOnePartAndTwentyCells_UpgradingStaysCellsOnly()
        {
            ...
            // 0 parts, 20 cells: must fail and consume NOTHING.
            ...
            // 1 part, 19 cells: must fail and consume NOTHING.
            PickupWallet.AddPart();
            PickupWallet.TrySpendPowerCells(1); // 20 -> 19
            ...
            Assert.That(PickupWallet.PowerCells, Is.EqualTo(19));

            // 1 part, 20 cells: must succeed and spend EXACTLY both.
            PickupWallet.SetPowerCells(CellSpend.UnlockCostCells);
            ...
            PickupWallet.SetPowerCells(CellSpend.UpgradeCostCells);
            ...
            Assert.That(PickupWallet.PowerCells, Is.EqualTo(0), "the upgrade must cost exactly 10 cells");
        }
    }
}
