...
namespace MaxWorlds.UI
{
    ...
    public abstract class AbilityJoystickControlBase : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        /// feels the same weight under a thumb.
        ///
        /// MV-502 note: this class does NOT use <c>UnityEngine.InputSystem.OnScreen.OnScreenStick</c>
        /// at all — it drives its own drag state directly off <see cref="IPointerDownHandler"/>/
        /// <see cref="IDragHandler"/>/<see cref="IPointerUpHandler"/>, so it never goes through
