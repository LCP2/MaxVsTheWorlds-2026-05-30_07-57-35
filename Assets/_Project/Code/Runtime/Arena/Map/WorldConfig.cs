...
namespace MaxWorlds.Arena
{
    ...
    /// <see cref="WorldSludge"/>'s MIN-corner rects), since a Lurker's garrison entry must COINCIDE with
    /// one of these exactly — <see cref="MapValidation"/> checks the two against each other directly,
    /// with no rect math in between.</summary>
    [Serializable]
    public sealed class WorldGrate
    {
        public string id;
        public float x;
        public float z;
    ...
    public sealed class WorldComposition
    {
        ...
        /// <summary>MV-688: the Grate Lurker — authored-composition only, same footing as
        /// <see cref="bolter"/>, and never drawn by <see cref="MaxWorlds.Enemies.EnemyMix.AreaCadence"/>'s
        ...
        /// <summary>MV-707: the Cart Charger — authored-composition only, same footing as
        /// <see cref="bolter"/>/<see cref="sludger"/>, drawn by the ambient shed cadence (it needs no
        /// grate coincidence, unlike <see cref="lurker"/>).</summary>
        public int charger;
    ...
    public sealed class WorldEnemyTypes
    {
        ...
        // MV-688: same optional/fallback footing as bolter above.
        public WorldEnemyTypeEntry lurker;

        // MV-705: same optional/fallback footing as bolter above.
        public WorldEnemyTypeEntry sludger;
        ...
        public float WeightedThv(DifficultyEngine.Composition c) =>
            ...
            c.Lurker * Thv(EnemyKind.Lurker) + c.Sludger * Thv(EnemyKind.Sludger) +
            c.Charger * Thv(EnemyKind.Charger);
    }
