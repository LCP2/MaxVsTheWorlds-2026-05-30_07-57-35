namespace MaxWorlds.Pickups
{
    ...
    /// their effects are YT-133 — here a part is generic. A <see cref="PickupKind.Device"/> is a shed's
    /// drop (WV-229): walking over it grants the <see cref="Pickup.Ability"/> it carries outright.
    /// </summary>
