...
namespace MaxWorlds.Pickups
{
    ...
    public static class CellEconomyTuning
    {
        ...
        /// for every Parts pickup dropped (MV-672) — 1-for-1 by default (MV-767 raised this from
        /// MV-680's 0.4; Rack ammo was the scarcest thing in World 2 and the reason the secondary
        /// weapon went unused). Tunable via <see cref="MaxWorlds.Core.DevTuning.PowerCellDropRatio"/>;
